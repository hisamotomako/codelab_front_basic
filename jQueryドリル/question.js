$(function() {
  ...
  // 問題4:子孫セレクター
  // 子孫セレクターを使い、クラス属性「q4」のspanタグ内の文字の色を赤色に変えてください。
  ...
  // 疑似クラスを使い、クラス属性「q8」の最初の要素(item1)の文字の色を赤色に変えてください。
  ...
  // 問題11:疑似クラス empty
  // 疑似クラスemptyを使い、li要素が空の時、リストの文頭に付く点の色を赤色に変えてください。
  ...
  $(".q14 span:only-child").css("color", "red");
  ...
  $(".q23 li:not(.q23item)").css("color", "red");
  ...
  $(".q30 li:even").next().css("color", "red");

  // 問題31:oddセレクター
  // oddセレクターを使い、奇数番目のli要素の文字の色を赤色に変えてください。
  $(".q31 li:odd").prev().css("color", "red");
  ...
  // 問題35:headerセレクター
  // headerセレクターを使い、heading要素の文字の色を赤色に変えてください。
  ...
  $(".pre-item").prev("li").css("color", "red");
  ...
  $("a").attr("href", "https://codelabo.net/training/");
